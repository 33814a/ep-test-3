...
map.getView().fit([-822169.891938, 6958113.786080, -750892.413283, 6999206.332486], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Electric Picnic 2025</h2>';
        return titleElement;
    })(),
